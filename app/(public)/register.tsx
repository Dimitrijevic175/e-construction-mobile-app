...
//                     <Text className="font-nunito font-bald text-5xl mt-10 text-center text-primary"> REGISTRATION </Text>
//
//                     {/* User Type Selection */}
//                     <Text className="font-nunito font-bold mt-12"> Are you a client or worker ?</Text>
//                     <View className="flex-row justify-start mb-5 mt-3 ml-1">
//
...
//                                 className={`
//                   flex-row items-center mr-6
//                   ${userType === type ? "opacity-100" : "opacity-50"}
//                 `}
//                             >
//                                 <View
//                                     className={`
//                     w-5 h-5 mr-2 rounded-full border-2
...
//
//                     <Button
//                         onPress={() => alert(`Registracija: ${userType}`)}
//                         variant="primary"
//                         className="mt-8"
//                     >
//                         Register
